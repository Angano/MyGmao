 ...
 */
final class Version20211106070235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__intervention AS SELECT id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur FROM intervention');
        $this->addSql('DROP TABLE intervention');
        $this->addSql('CREATE TABLE intervention (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, materiel_id INTEGER NOT NULL, technicien_id INTEGER DEFAULT NULL, client_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, status BOOLEAN NOT NULL, symptome CLOB NOT NULL COLLATE BINARY, travaux CLOB DEFAULT NULL COLLATE BINARY, compteur VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_D11814AB16880AAF FOREIGN KEY (materiel_id) REFERENCES materiel (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D11814AB13457256 FOREIGN KEY (technicien_id) REFERENCES technicien (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D11814AB19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO intervention (id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur) SELECT id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur FROM __temp__intervention');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__technicien AS SELECT id, nom, prenom, metier FROM technicien');
        ...
        $this->addSql('INSERT INTO technicien (id, nom, prenom, metier) SELECT id, nom, prenom, metier FROM __temp__technicien');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__intervention AS SELECT id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur FROM intervention');
        $this->addSql('DROP TABLE intervention');
        $this->addSql('CREATE TABLE intervention (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, materiel_id INTEGER NOT NULL, technicien_id INTEGER DEFAULT NULL, client_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, status BOOLEAN NOT NULL, symptome CLOB NOT NULL, travaux CLOB DEFAULT NULL, compteur VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO intervention (id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur) SELECT id, materiel_id, technicien_id, client_id, date, status, symptome, travaux, compteur FROM __temp__intervention');
        $this->addSql('DROP TABLE __temp__intervention');
        $this->addSql('CREATE INDEX IDX_D11814AB16880AAF ON intervention (materiel_id)');
        $this->addSql('CREATE INDEX IDX_D11814AB13457256 ON intervention (technicien_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__technicien AS SELECT id, nom, prenom, metier FROM technicien');
        $this->addSql('DROP TABLE technicien');
        $this->addSql('CREATE TABLE technicien (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, metier VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO technicien (id, nom, prenom, metier) SELECT id, nom, prenom, metier FROM __temp__technicien');
        $this->addSql('DROP TABLE __temp__technicien');
    }
}
